...
export {
    ...
    AlarmTrait, DndTrait, OverTempTrait, SystemTrait, TimerTrait, TriggerTrait
} from './traits';
export type {
    ...
    DiffuserValues, DiffuserLightMode, DiffuserSprayMode, MediaValues, AlarmValues, DndValues, OverTempValues,
